...
原子是元素能保持其化学性质的最小单位。原子由原子核和绕核旋转的电子组成。原子核由质子和中子组成。质子带正电荷，电子带负电荷，中子不带电。
...
电子轨道不是像行星绕太阳旋转那样稳定的有形的一个轨道，人们无法测定电子的具体位置，只知道一个在原子核周围空间的电子存在的概率分布。电子有不同的轨道，轨道有三个特征(称为轨道量子数)：
...
1803年英国化学家提出倍比定理：若两元素可以生成两种或两种以上的化合物时，在这些化合物中，一元素的质量固定，则另一元素的质量成简单整数比。举例而言：一氧化碳（CO）和二氧化碳（CO2）同是碳的氧化物。100克的碳和133克的氧反应以生成一氧化碳，和266克氧反应以生成二氧化碳。此二种化合物中氧，其质量比是1:2（133:266），为简单整数比。据此他提出了初步的原子力量，并且奠定了后世使用化学式的基础。道尔顿的原子理论并没有涉及原子本身的结构。关于原子结构的现代原子模型，直到基本粒子被发现以及量子的概念被引入后才被逐步建立。

![img](file:///Users/xuguang/popular_science/Atomic_resolution_Au100.jpeg?lastModify=1563233856)
